...
class Jogador:
    ...
    def transforma_zumbi(self):
        self.peca.jogadorSprite = JogadorSprite("assets/zumbi.png", (55, 80),  (50, 700))
...
class JogadorSprite(pygame.sprite.Sprite):
    def __init__(self, imagePath, size, posicao_inicial):
        super().__init__()
        self.imagem = pygame.image.load(imagePath).convert_alpha()  # Carrega a imagem do peão do jogador
        self.imagem = pygame.transform.scale(self.imagem, size)  # Redimensiona a imagem
